...
public class Configuracao {
    ...
    private double limiteAr = 10.0; //Implementar depois no Display, JanelaHidrometro e Hidrometro
    ...
    private void carregarParametros() {
        ...
        try (FileInputStream fis = new FileInputStream(ARQUIVO_CONFIG)) {
            ...
            limiteAr = Double.parseDouble(props.getProperty("limite.ar", "10.0")); //Implementar depois no Display, JanelaHidrometro e Hidrometro
    ...
    public double getLimiteAr() { return limiteAr; } //Implementar depois no Display, JanelaHidrometro e Hidrometro
